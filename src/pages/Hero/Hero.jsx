...
const Hero = () => {
  return (
    <div className="text-center">
      <div className="bg-[linear-gradient(to_right_bottom,rgba(49,84,44,0.8),rgba(16,71,52,0.8)),url('https://i.ibb.co/rpHkYFY/hero-bg.jpg')] w-full h-[calc(100vh-75px)] bg-center  bg-cover">
